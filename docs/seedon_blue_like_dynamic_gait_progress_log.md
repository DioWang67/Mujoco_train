...
This append-only log tracks Seedon Blue / BDX-like dynamic gait experiments, diagnostics, controller results, and engineering decisions.
...
```powershell
.venv\Scripts\python.exe -m tools.seedon_phase1_5_force_split_rollover_controller --steps 600 --max-forward-bias 2.0 --forward-ramp-rate 0.04 --support-ratio-enter 0.58 --support-ratio-exit 0.54 --max-roll 0.055 --max-pitch 0.012
```

### Outputs

- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_5_force_split_rollover\phase1_5_timeline.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_5_force_split_rollover\phase1_5_summary.json`
...
```powershell
.venv\Scripts\python.exe -m tools.seedon_phase1_6_load_transfer_attribution --steps 200
```

### Outputs

- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_6_load_transfer_attribution\phase1_6_trials.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_6_load_transfer_attribution\phase1_6_summary.json`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_6_load_transfer_attribution\phase1_6_top_candidates.csv`
...
```powershell
.venv\Scripts\python.exe -m tools.seedon_phase1_7_load_transfer_profile_shaping --steps 240
```

### Outputs

- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_7_load_transfer_profile_shaping\phase1_7_trials.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_7_load_transfer_profile_shaping\phase1_7_summary.json`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase1_7_load_transfer_profile_shaping\phase1_7_top_candidates.csv`
...
```powershell
.venv\Scripts\python.exe -m tools.seedon_phase2a_right_support_micro_capture --steps 260
```

### Outputs

- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2a_right_support_micro_capture\phase2a_trials.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2a_right_support_micro_capture\phase2a_summary.json`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2a_right_support_micro_capture\phase2a_top_candidates.csv`
...
```powershell
.venv\Scripts\python.exe -m tools.seedon_phase2b_micro_capture_refinement --steps 280
```

### Outputs

- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2b_micro_capture_refinement\phase2b_trials.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2b_micro_capture_refinement\phase2b_summary.json`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2b_micro_capture_refinement\phase2b_top_candidates.csv`
...
```powershell
.venv\Scripts\python.exe -m tools.seedon_phase2c_contact_constrained_foot_mapping --steps 240
```

### Outputs

- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2c_contact_constrained_foot_mapping\phase2c_joint_mapping.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2c_contact_constrained_foot_mapping\phase2c_contact_constrained_mapping.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2c_contact_constrained_foot_mapping\phase2c_rollover_timeline.csv`
- `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase2c_contact_constrained_foot_mapping\phase2c_summary.json`
...
## 2026-06-01 - Phase M0 Seedon vs Open Duck Morphology Audit
...
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_joint_topology.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\duck_joint_topology.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\joint_topology_comparison.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_actuator_inventory.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\duck_actuator_inventory.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\actuator_comparison.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_morphology_metrics.json`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\duck_morphology_metrics.json`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\morphology_comparison.json`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\morphology_comparison.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_foot_geom_inventory.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\duck_foot_geom_inventory.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\foot_contact_style_comparison.md`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_joint_effect_probe.csv`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_joint_sign_mapping.json`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\seedon_duck_scaled_gait_reference.json`
* `D:\Git\robotlearning\seedon_mujoco\artifacts\seedon_debug\phase_m0_duck_morphology_audit\phase_m0_duck_morphology_audit_report.md`
* `docs/seedon_blue_like_dynamic_gait_progress_log.md`
...
| Metric | Value |
| --- | ---: |
| seedon_target_vx | 0.141672 |
| seedon_gait_period | 0.570959 |
| seedon_foot_clearance_target | 0.042626 |
| seedon_flight_ratio_target | 0.000000 |
| seedon_action_scale_initial | 0.250000 |
...
- `tools/seedon_phase_g1_raw_contact_pair_diagnostic.py`
- `artifacts/seedon_debug/phase_g1_raw_contact_pair_diagnostic/raw_contact_pairs.csv`
- `artifacts/seedon_debug/phase_g1_raw_contact_pair_diagnostic/contact_region_summary.csv`
- `artifacts/seedon_debug/phase_g1_raw_contact_pair_diagnostic/contact_geom_inventory.csv`
- `artifacts/seedon_debug/phase_g1_raw_contact_pair_diagnostic/phase_g1_summary.json`
- `artifacts/seedon_debug/phase_g1_raw_contact_pair_diagnostic/phase_g1_report.md`

### Commands

```text
python -m py_compile tools/seedon_phase_g1_raw_contact_pair_diagnostic.py
.venv\Scripts\python.exe -m tools.seedon_phase_g1_raw_contact_pair_diagnostic --neutral-only
.venv\Scripts\python.exe -m tools.seedon_phase_g1_raw_contact_pair_diagnostic --pitch-sweep
```
...
Decide whether Seedon is ready for a conservative Phase W0-DuckRef scripted walking smoke test, using M0, G1, actuator semantics, and free-space joint sign evidence.

### Files

- `tools/seedon_phase_pre_w0_actuator_semantics_audit.py`
- `tools/seedon_phase_pre_w0_free_space_joint_sign_validation.py`
- `tools/seedon_phase_pre_w0_duckref_readiness_check.py`
- `artifacts/seedon_debug/phase_pre_w0_actuator_semantics_audit/seedon_actuator_semantics_inventory.csv`
- `artifacts/seedon_debug/phase_pre_w0_actuator_semantics_audit/seedon_actuator_semantics_summary.json`
- `artifacts/seedon_debug/phase_pre_w0_actuator_semantics_audit/seedon_actuator_semantics_report.md`
- `artifacts/seedon_debug/phase_pre_w0_free_space_joint_sign_validation/seedon_free_space_joint_effect_probe.csv`
- `artifacts/seedon_debug/phase_pre_w0_free_space_joint_sign_validation/seedon_free_space_joint_sign_mapping.json`
- `artifacts/seedon_debug/phase_pre_w0_free_space_joint_sign_validation/seedon_free_space_joint_sign_validation_report.md`
- `artifacts/seedon_debug/phase_pre_w0_duckref_readiness_check/phase_pre_w0_duckref_readiness_summary.json`
- `artifacts/seedon_debug/phase_pre_w0_duckref_readiness_check/phase_pre_w0_duckref_readiness_report.md`
- `docs/seedon_blue_like_dynamic_gait_progress_log.md`

### Commands

```text
python -m py_compile tools/seedon_phase_pre_w0_actuator_semantics_audit.py
python -m py_compile tools/seedon_phase_pre_w0_free_space_joint_sign_validation.py
python -m py_compile tools/seedon_phase_pre_w0_duckref_readiness_check.py
.venv\Scripts\python.exe -m tools.seedon_phase_pre_w0_actuator_semantics_audit
.venv\Scripts\python.exe -m tools.seedon_phase_pre_w0_free_space_joint_sign_validation
.venv\Scripts\python.exe -m tools.seedon_phase_pre_w0_duckref_readiness_check
```
...
Seedon actuator metadata is clear enough for W0: all 10 actuators classify as motor-like and no unknown actuator semantics remain. Free-space joint sign validation agrees with the M0 mapping for all 10 validated leg joints. G1 confirms right-center contact is physically possible.
...
## 2026-06-02 - Seedon v5_22 Toe Handoff Targeted Probe

### Goal

Run a bounded, controlled posture sweep on Seedon v5_22 foot prototype variants to check whether center-to-toe load transfer is physically observable before controller gait sequencing or PPO.

### Files

- `tools/seedon/diagnostics/v5_22/run_seedon_v5_22_toe_handoff_probe.py`
- `configs/seedon/seedon_v5_22_toe_handoff_probe.yaml`
- `docs/seedon_v5_22_toe_handoff_probe_report.md`
- `artifacts/seedon_debug/v5_22_toe_handoff_probe/probe_results.csv`
- `artifacts/seedon_debug/v5_22_toe_handoff_probe/metrics.json`
- `artifacts/seedon_debug/v5_22_toe_handoff_probe/raw_contacts.csv`

### Commands

```text
.venv\Scripts\python.exe -B -m py_compile tools\seedon\diagnostics\v5_22\run_seedon_v5_22_toe_handoff_probe.py
.venv\Scripts\python.exe -B tools\seedon\diagnostics\v5_22\run_seedon_v5_22_toe_handoff_probe.py
```
