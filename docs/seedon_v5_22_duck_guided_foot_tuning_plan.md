...
- Duck XML does not expose explicit toe/center/heel primitive patches, so manual Duck foot contact review is required before running Duck-guided Seedon tuning.
