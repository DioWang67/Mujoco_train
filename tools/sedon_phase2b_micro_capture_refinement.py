"""Phase 2B force-gated micro-capture refinement for Sedon.
...
def main(argv: list[str] | None = None) -> int:
    ...
    command = f".venv\\Scripts\\python.exe -m tools.sedon_phase2b_micro_capture_refinement --steps {args.steps}"
    summary = run_sweep(
