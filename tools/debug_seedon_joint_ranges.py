"""Compare Seedon URDF joint limits with MuJoCo joint ranges."""
...
from seedon_baseline.env import DEFAULT_SCENE_PATH, JOINT_NAMES
from tools.seedon_debug_common import DEBUG_OUT_DIR


DEFAULT_ORIGINAL_URDF = Path("private_assets/seedon/original_urdf_package/urdf/urdf/urdf.urdf")
DEFAULT_PREPARED_URDF = Path("private_assets/seedon/mjcf_source/seedon.urdf")
