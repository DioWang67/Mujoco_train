"""Static pitch-tilt contact handoff diagnostic for Seedon foot geometry.
...
from tools.seedon_debug_common import DEFAULT_SCENE_PATH, DEBUG_OUT_DIR, geom_name, require_scene
...
def _force_bucket(geom: str) -> tuple[str, str] | None:
    """Return (side, region) for Seedon foot geoms used in Blue-like soles."""
