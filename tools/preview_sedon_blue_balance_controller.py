"""Preview a Blue-like closed-loop balance controller for Sedon.
...
Sedon's existing joint-space PD tracking.
"""
...
def _estimate_state(
    ...
    *,
    ...
    # Sedon's left foot is on negative world-Y, so support-side COM shift should
