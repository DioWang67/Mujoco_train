"""Isolate Seedon hip-roll controllability across kinematic and dynamics modes."""
...
def _foot_contact_flags(env: SeedonStandingEnv) -> tuple[bool, bool]:
...
def _restore_floor_contact(env: SeedonStandingEnv, floor_geom_id: int, original_contype: int, original_conaffinity: int) -> None:
...
def _disable_floor_contact(env: SeedonStandingEnv, floor_geom_id: int) -> tuple[int, int]:
