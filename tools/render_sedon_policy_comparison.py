"""Render Sedon teacher/probe policy rollouts to MP4 videos."""
...
DEFAULT_OUT_DIR = REPO_ROOT / "artifacts" / "sedon_debug" / "render"
DEFAULT_TEACHER_MODEL = REPO_ROOT / "models" / "sedon" / "teacher_safe_baseline" / "model.zip"
DEFAULT_TEACHER_VECNORM = REPO_ROOT / "models" / "sedon" / "teacher_safe_baseline" / "vecnorm.pkl"
DEFAULT_PROBE_MODEL = REPO_ROOT / "models" / "sedon" / "latest_model.zip"
DEFAULT_PROBE_VECNORM = REPO_ROOT / "models" / "sedon" / "vecnorm.pkl"
...
def render_policy(
    ...
    *,
    ...
    """Render one deterministic Sedon policy rollout."""
    if steps <= 0:
