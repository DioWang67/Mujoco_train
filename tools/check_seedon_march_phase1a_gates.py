"""Check Seedon march Phase 1A gates across hip-roll residual scales."""
...
from tools.check_seedon_march_phase12_gates import (
    GateThresholds,
    _evaluate_phase,
    _load_config,
    _load_model,
...
DEFAULT_CONFIGS = (
    REPO_ROOT / "configs" / "seedon" / "march_phase1a_load_transfer_roll_0005.json",
    REPO_ROOT / "configs" / "seedon" / "march_phase1a_load_transfer_roll_0010.json",
    REPO_ROOT / "configs" / "seedon" / "march_phase1a_load_transfer_roll_0015.json",
)
