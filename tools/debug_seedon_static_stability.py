"""Check Seedon COM placement and static single-foot support stability."""
...
def _support_box(env: SeedonStandingEnv, geom_name: str) -> SupportBox:
...
def _set_foot_sizes(env: SeedonStandingEnv, foot_size: tuple[float, float, float]) -> None:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--csv-path",
        type=Path,
        default=Path("artifacts") / "seedon_debug" / "static_stability_summary.csv",
