"""Sweep Seedon foot contact geometry overrides under with-floor load transfer."""
...
def _apply_base_height_delta(env: SeedonStandingEnv, base_height_delta: float) -> None:
