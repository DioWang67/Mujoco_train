"""Audit Seedon shuffle v0 curriculum against low-threshold in-place criteria."""
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "seedon" / "shuffle_v0.json"
...
def _load_config(path: Path) -> SeedonStandingConfig:
    """Load a Seedon config JSON override."""
...
def _collect_raw_infos(
    ...
    """Collect rollout infos from an unnormalized Seedon environment."""
...
def _collect_vecnorm_infos(
    ...
    raw_env: SeedonStandingEnv = dummy_env.envs[0]
