"""Preview a Blue-like contact-gated Seedon gait without PPO training.

The controller keeps Seedon in conservative double support unless floor-contact
...
def _smooth_alpha(env: SeedonStandingEnv, step_count: int, ramp_steps: int) -> float:
