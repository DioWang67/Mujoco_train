"""Sweep a relaxed-foot 1600-step robust Sedon FSM gait without PPO training.
...
from sedon_baseline.env import JOINT_NAMES, SedonStandingEnv
...
def _make_fsm(candidate: FsmCandidate):
    ...
    def _fsm(self: SedonStandingEnv) -> np.ndarray:
        total_steps = (
...
def _rollout_candidate(
    ...
    *,
    ...
    original = SedonStandingEnv._fsm_gait_joint_offsets
    SedonStandingEnv._fsm_gait_joint_offsets = _make_fsm(candidate)
    ...
    try:
        ...
        env.close()
        SedonStandingEnv._fsm_gait_joint_offsets = original
