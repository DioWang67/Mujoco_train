"""Check whether Seedon can lift a swing foot when support load is forced.
...
def _apply_lateral_force(env: SeedonStandingEnv, support_side: str, force_n: float) -> None:
...
def _clear_lateral_force(env: SeedonStandingEnv) -> None:
