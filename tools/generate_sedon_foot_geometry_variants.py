"""Generate Sedon foot-geometry scene variants and optional diagnostics.

This is an experiment helper only. It never overwrites the canonical
``private_assets/sedon/training_scene.xml`` and does not invoke PPO training.
"""
...
class FootVariant:
    """One generated Sedon foot geometry variant."""
...
def generate_variants(source_scene: Path, out_dir: Path) -> list[dict[str, Any]]:
    ...
    Args:
        source_scene: Canonical Sedon scene to read.
    ...
    Raises:
        ...
        ValueError: If the expected Sedon foot geoms are missing.
    """
...
def run_diagnostics(payloads: list[dict[str, Any]], out_dir: Path) -> None:
    """Run existing Sedon debug diagnostics for every generated variant."""
        ...
        commands = [
            ...
            (
                ...
                [
                    sys.executable,
                    "-m",
                    "tools.debug_sedon_lateral_controllability",
                    "--scene-path",
                    scene_path,
                    "--ramp-steps",
                    "40",
            ...
            (
                ...
                [
                    sys.executable,
                    "-m",
                    "tools.debug_sedon_single_support_load_transfer",
                    "--scene-path",
                    scene_path,
                    "--support-side",
                    "left",
            ...
            (
                ...
                [
                    sys.executable,
                    "-m",
                    "tools.debug_sedon_static_stability",
                    "--scene-path",
                    scene_path,
                    "--plan",
                    "both",
            ...
            (
                ...
                [
                    sys.executable,
                    "-m",
                    "tools.debug_sedon_foot_contact_geometry_sweep",
                    "--scene-path",
                    scene_path,
                    "--steps",
                    "80",
...
def write_report(payloads: list[dict[str, Any]], out_dir: Path) -> Path:
    ...
    lines = [
        "# Sedon Rounded Sole Foot Geometry Experiment",
        "",
