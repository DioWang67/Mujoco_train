"""Sweep Sedon PD gains under floor contact to isolate load-transfer authority."""
...
def _target_positions(env: SedonStandingEnv, support_side: str, hip_roll_offset: float) -> np.ndarray:
