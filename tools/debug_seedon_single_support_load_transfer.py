"""Diagnose whether Seedon can transfer load into usable single support."""
...
from tools.seedon_debug_common import DEFAULT_SCENE_PATH, DEBUG_OUT_DIR, contact_pairs, require_scene
