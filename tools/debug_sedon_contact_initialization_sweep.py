"""Sweep Sedon reset base-height offsets and measure contact initialization stability."""
...
from tools.sedon_debug_common import DEBUG_OUT_DIR, LEFT_FOOT_GEOM, RIGHT_FOOT_GEOM, contact_pairs
...
def _snapshot(env: SedonStandingEnv) -> dict[str, float | int | str]:
