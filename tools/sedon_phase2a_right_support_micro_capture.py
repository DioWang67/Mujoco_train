"""Phase 2A right-support force-gated micro capture diagnostic for Sedon.
...
def _left_foot_pos(env: SedonStandingEnv) -> tuple[float, float, float]:
...
def main(argv: list[str] | None = None) -> int:
    ...
    command = f".venv\\Scripts\\python.exe -m tools.sedon_phase2a_right_support_micro_capture --steps {args.steps}"
    summary = run_sweep(
