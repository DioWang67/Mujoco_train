"""Run Sedon v5_22 foot x actuator/controller bounded sensitivity.
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "sedon" / "sedon_v5_22_foot_actuator_sensitivity.yaml"
PATCH_METADATA = {
...
def foot_length_status(feet: dict[str, FootGeom]) -> tuple[bool, str]:
    ...
    return True, "resolved_from_v5_22_sedon_foot_collision_box_size"
...
def write_report(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        "# Sedon v5_22 Foot x Actuator Sensitivity Report",
        "",
