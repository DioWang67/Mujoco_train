"""Run Sedon v5_22 continuous foot bottom prototype probe.
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "sedon" / "sedon_v5_22_continuous_foot_bottom_probe.yaml"
SIDES = ("left", "right")
...
def foot_body_for_side(side: str) -> str:
    """Return Sedon foot body for side."""

    return FOOT_SPECS[side]["body"]


def side_for_geom(name: str) -> str:
    """Classify Sedon side from geom name."""
...
def is_variant_foot_geom(name: str) -> bool:
    """Return whether name looks like Sedon foot contact geometry."""
...
def write_report(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        "# Sedon v5_22 Continuous Foot Bottom Probe Report",
        "",
