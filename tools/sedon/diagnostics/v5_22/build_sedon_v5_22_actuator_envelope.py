"""Build the Sedon v5_22 actuator envelope.
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "sedon" / "sedon_v5_22_actuator_envelope.yaml"
DEFAULT_OUTPUT = REPO_ROOT / "artifacts" / "sedon_debug" / "v5_22_actuator_envelope" / "envelope.json"
DEFAULT_REPORT = REPO_ROOT / "docs" / "sedon_v5_22_actuator_envelope_report.md"
...
def controller_semantics(path: Path) -> dict[str, Any]:
    """Extract Python controller semantics from sedon_baseline/env.py."""
...
def write_report(path: Path, payload: dict[str, Any]) -> None:
    ...
    path.parent.mkdir(parents=True, exist_ok=True)
    lines = [
        "# Sedon v5_22 Actuator Envelope Report",
        "",
...
def main() -> int:
    """Build Sedon v5_22 actuator envelope."""
