"""Run Sedon v5_22 toe handoff targeted probe.
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "sedon" / "sedon_v5_22_toe_handoff_probe.yaml"
FORCE_EPS = 1e-5
...
def write_report(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        "# Sedon v5_22 Toe Handoff Targeted Probe Report",
        "",
