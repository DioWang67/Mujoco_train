"""Run the Sedon v5_22 mechanical sanity gate.
...
DEFAULT_CONFIG_PATH = REPO_ROOT / "configs" / "sedon" / "sedon_v5_22_sanity_gate.yaml"
DEFAULT_ARTIFACTS_DIR = REPO_ROOT / "artifacts" / "sedon_debug" / "v5_22_sanity_gate"
DEFAULT_REPORT_PATH = REPO_ROOT / "docs" / "sedon_v5_22_sanity_gate_report.md"
...
class ResolvedSource:
    ...
    Args:
        ...
        appears_v5_22: Whether the path appears to be Sedon v5_22.
...
def classify_source_type(path: Path) -> str:
    ...
    if suffix == ".urdf":
        return "urdf"
    if suffix == ".xml" and "sedon_v5_22" in str(path).lower():
...
def write_report(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        "# Sedon v5_22 Mechanical Sanity Gate Report",
        "",
