"""Sweep Sedon mass distribution and stance width for lateral COM diagnostics.
...
def _body_ids(env: SedonStandingEnv, body_names: tuple[str, ...]) -> list[int]:
...
def _apply_stance_width_scale(env: SedonStandingEnv, scale: float, original_body_pos: np.ndarray) -> None:
...
def _left_support_target(env: SedonStandingEnv, hip_roll_offset: float) -> np.ndarray:
...
def main(argv: list[str] | None = None) -> int:
    """Run the Sedon COM/mass-distribution sweep."""
