"""Two-stage Sedon preload sweep with stance knee/ankle and swing hip-roll deltas."""
...
DEFAULT_OUT_CSV = DEBUG_OUT_DIR / "sedon_preload_sweep_v2.csv"
...
def _contact_metrics(env: SedonStandingEnv) -> tuple[float, float, float, bool, bool]:
...
def _build_target(env: SedonStandingEnv, candidate: PreloadV2Candidate) -> np.ndarray:
...
def _collect_frame_metrics(env: SedonStandingEnv) -> FrameMetrics:
