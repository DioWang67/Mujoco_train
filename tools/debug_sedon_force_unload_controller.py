"""Run a focused closed-loop Sedon force-unload controller proof.
...
def _build_target(env: SedonStandingEnv, case: ControllerCase, support_roll_cmd: float) -> np.ndarray:
...
def main(argv: list[str] | None = None) -> int:
    ...
    if summaries and summaries[0].diagnosis == "scripted_force_unload_success":
        ...
        print("interpretation: this controller cannot unload Sedon; inspect authority/contact/mass before training.")
    return 0
