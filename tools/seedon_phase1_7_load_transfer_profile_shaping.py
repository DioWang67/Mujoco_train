"""Phase 1.7 load-transfer profile shaping for Seedon.
...
def main(argv: list[str] | None = None) -> int:
    ...
    del args.max_pitch
    command = f".venv\\Scripts\\python.exe -m tools.seedon_phase1_7_load_transfer_profile_shaping --steps {args.steps}"
    summary = run_sweep(
