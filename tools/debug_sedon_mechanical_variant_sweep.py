"""Sweep Sedon mechanical proxy variants against a force-unload gate.
...
def _apply_foot_scale(env: SedonStandingEnv, xy_scale: float, z_scale: float) -> None:
...
def _apply_foot_friction(env: SedonStandingEnv, friction: float) -> None:
...
def _apply_base_com_offset(env: SedonStandingEnv, z_offset: float) -> None:
...
def _target(env: SedonStandingEnv, support_side: str, support_roll: float) -> np.ndarray:
