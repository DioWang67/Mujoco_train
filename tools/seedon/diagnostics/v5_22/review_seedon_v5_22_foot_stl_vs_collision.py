"""Review Seedon v5_22 foot STL geometry against MuJoCo foot collision.
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "seedon" / "seedon_v5_22_foot_stl_review.yaml"
SIDES = ("left", "right")
...
def path_priority(path: Path) -> int:
    """Prefer v5_22 assets over older duplicate Seedon assets."""

    normalized = rel_path(path).lower()
    if "seedon_v5_22" in normalized:
        return 0
