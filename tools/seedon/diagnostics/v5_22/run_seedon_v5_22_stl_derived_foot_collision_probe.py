"""Run Seedon v5_22 STL-derived foot collision prototype probe.
...
from tools.seedon.diagnostics.v5_22.review_seedon_v5_22_foot_stl_vs_collision import (
    Bounds,
    bounds_from_vertices,
    bounds_payload,
    read_stl_vertices,
)
from tools.seedon.diagnostics.v5_22.run_seedon_v5_22_continuous_foot_bottom_probe import (
    local_contact_x,
)
...
DEFAULT_CONFIG = REPO_ROOT / "configs" / "seedon" / "seedon_v5_22_stl_derived_foot_collision_probe.yaml"
SIDES = ("left", "right")
...
def side_for_geom(name: str) -> str:
    """Classify Seedon side from generated foot geom name."""
...
def write_report(path: Path, payload: dict[str, Any]) -> None:
    ...
    lines = [
        "# Seedon v5_22 STL-Derived Foot Collision Probe Report",
        "",
