...
periods from robot XML, or generate Seedon trajectories.
"""
...
def scan_files(search_root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "purpose": "Identify local Duck gait/reference motion source metadata for Seedon Duck-like gait preparation.",
