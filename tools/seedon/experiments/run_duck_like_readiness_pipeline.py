"""Summarize the Seedon Duck-like gait readiness pipeline.
...
TOOL_VERSION = "seedon-duck-like-readiness-pipeline-v1"

REPO_ROOT = Path(__file__).resolve().parents[3]
DEFAULT_REPORT = REPO_ROOT / "docs" / "seedon_duck_like_pipeline.md"

PHASE_OUTPUTS = [
    {
        "phase": 1,
        "name": "normalized_scale_table",
        "path": REPO_ROOT / "configs" / "seedon" / "seedon_duck_scale_mapping.yaml",
    ...
    },
    {
        ...
        "path": REPO_ROOT / "configs" / "seedon" / "seedon_duck_joint_sign_mapping.yaml",
        "status_path": ["summary", "status"],
        "pass_statuses": {"READY"},
    },
    {
        "phase": 3,
        "name": "seedon_actuator_envelope",
        "path": REPO_ROOT / "configs" / "seedon" / "seedon_actuator_envelope.yaml",
        "status_path": ["summary", "status"],
        "pass_statuses": {"READY", "INCONCLUSIVE"},
    },
    {
        "phase": 4,
        "name": "seedon_contact_patch_readiness",
        "path": REPO_ROOT / "configs" / "seedon" / "seedon_contact_patch_status.yaml",
        "status_path": ["summary", "status"],
        "pass_statuses": {"READY"},
    },
    {
    ...
    },
    {
        ...
        "path": REPO_ROOT / "configs" / "seedon" / "seedon_duck_like_gait_reference.yaml",
        "status_path": ["summary", "status"],
