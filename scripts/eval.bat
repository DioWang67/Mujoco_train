...
echo.
echo Seedon:
echo   14. Local Seedon eval with viewer (best checkpoint)
echo   15. Local Seedon eval record GIF (best checkpoint)
echo   16. Local Seedon eval headless (5 eps)
echo.
...
if "%choice%"=="14" %PYTHON% eval.py --project seedon --episodes 1 --render
if "%choice%"=="15" %PYTHON% eval.py --project seedon --episodes 1 --record
if "%choice%"=="16" %PYTHON% eval.py --project seedon --episodes 5
pause
